...
const routes = [
  ...
  // {path: '/aluno/pedidos/ic/pagina', name: 'PageICAluno', component: PageICAluno}, isso aqui nao era pra existir
  {
  ...
  {
    path: '/coordenador/estagio/submit',
