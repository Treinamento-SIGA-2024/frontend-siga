<template>
    <div>
      <PageTitle title="PROPOSTAS DE IC"/>
      <div class="card-container">
        <v-card 
          ...
          class="ic-card">
            ...
            <v-card-subtitle> Professor: {{ p.professores[0].nome }} </v-card-subtitle>
        </v-card>
      </div>
    </div>
  </template>
  ...
  export default {
    ...
    methods: {
      async getICsPendentes() { this.propostasIcs = await getICsPendentes(); },
    },
    created() {
